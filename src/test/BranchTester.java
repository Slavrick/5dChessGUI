...
public class BranchTester {
	...
	public static GameState getTestGS() {
		...
		Timeline t = new Timeline(b,true,1,0);
		GameState g = new GameState(t);
		Move m = new Move(new CoordFive(3,1,1,0), new CoordFive(3,3,1,0));
		Move m2 = new Move(new CoordFive(3,6,1,0), new CoordFive(3,4,1,0));
		Move m3 = new Move(new CoordFive(1,0,2,0), new CoordFive(2,2,2,0));
		Move m4 = new Move(new CoordFive(1,7,2,0), new CoordFive(1,5,1,0));
		g.makeTurn(m);
		g.makeTurn(m2);
		g.makeTurn(m3);
		g.makeTurn(m4);
